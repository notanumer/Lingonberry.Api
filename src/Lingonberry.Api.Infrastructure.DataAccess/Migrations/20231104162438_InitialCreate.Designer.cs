...
namespace Lingonberry.Api.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20231104162438_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lingonberry.Api.Domain.Store.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Lingonberry.Api.Domain.Store.Product", b =>
                {
                    b.HasOne("Lingonberry.Api.Domain.Users.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Lingonberry.Api.Domain.Users.User", "UpdatedByUser")
                        .WithMany()
